...
def MLPClassifier_with_grid_search(X_train_smote, Y_train_smote,x_train,y_train,x_cv,y_cv,x_test,y_test):
...
def MLPClassifier_best_model(X_train_smote, Y_train_smote,x_train,y_train,x_cv,y_cv,x_test,y_test):
